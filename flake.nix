{
  ...
  inputs = {
    ...
    # bambu-studio is marked unfree since May 2026 (SFC AGPL ruling,
    # nixpkgs#415821), so Hydra never caches it on ANY branch — expect one
    # local ~1 h compile per lock bump. orca-slicer stays cached.
