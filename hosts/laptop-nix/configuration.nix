...

{
  ...
  # Corporate GravityZone endpoint agent. Unsupported by the vendor on NixOS.
  # The module only covers the declarative half. Install the product itself
  # with hosts/laptop-nix/bitdefender/bootstrap.sh.
  dotfiles.system.bitdefender.enable = true;
