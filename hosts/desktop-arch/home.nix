...
in
{
  ...
  programs.niri = {
    ...
    # Host-specific niri bits: monitors and column-width presets. The terminal
    # launcher needs no override — modules/desktop/niri/binds.nix spawns the
    # terminal through `dotfiles.wrapGL`, which is nixGL here.
    settings = {
      layout = {
