...
let
  ...
  # Theme tokens come straight from the palette. It is a plain file rather
  # than a module precisely so this NixOS-scoped module can read it — the
  # home-manager `colors` arg is not visible here. Nothing below is a copy,
